...
describe('Promises Suite (Default)', function () {
  describe('Basic Tests', function () {
    ...
    it('promises methods return promises (thenables), so, we can chain requests and actions - and trust the results', function (done) {
      let myPromise = new Promise((resolve, reject) => {
        setTimeout(function () {
          resolve('Great Success!')
        }, 50)
      ...
      myPromise.then(function (data) {
        // Não sei o que é data mas vou criar uma nova promise de data e tratar aqui.
        Promise.resolve(data)
        // Se já era um promise, o resolve irá respeitar isso e resolver a promise.
        // Se não era um promise, o objeto retornado será um thenable. Neat.
          .then(function (err) {
